<template>
  <div class='hs-container' >
    <div class='pm-status'>
      ...
      <Col :span='4'>
        <div class='count-card'  :class="{'count-card-active':currentModule==3}"  @click='currentModule=3'><Icon custom='gzicon gzi-money'></Icon>产值<div class='sub'>PRODUCTION</div> <span class='ei-count'>{{hs.formatSalary(getTransferred(currentYear))}}<div class='unit'>元</div></span>
        </div>
      </Col>
       <Col :span='4'>
        <div class='count-card'  :class="{'count-card-active':currentModule==1}"  @click='currentModule=1'><Icon custom='gzicon gzi-supervisor'></Icon>员工 <span class='ei-count'>{{getHumans(currentYear)}}<div class='unit'>人</div></span>
        <div class='sub'>EMPLOYEES</div></div>
      </Col>
       <Col :span='4'>
        <div class='count-card'  :class="{'count-card-active':currentModule==2}"  @click='currentModule=2'><Icon custom='gzicon gzi-renzhengchenggong'></Icon>开票 <span class='ei-count'>{{hs.formatSalary(getBills(currentYear))}}<div class='unit'>元</div></span>
    ...
    <div style='margin:20px auto;width:1400px;overflow:hidden;position:relative;'>
...
export default {
  ...
  computed:{
    ...mapGetters('project',['getCount','getAmount','getHumans','getBills','getTransferred','getActivities']),
