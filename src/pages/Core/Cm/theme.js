define(function () {
  ...
  var theme = {
    // 榛樿鑹叉澘
    color: [
      '#8d98b3', '#e5cf0d', '#97b552', '#d87a80', '#2ec7c9', '#b6a2de', '#f5994e', '#7eb00a', '#c14089', '#c05050', '#5ab1ef', '#ffb980',
    ...
    toolbox: {
      color: [
        '#C1232B', '#B5C334', '#60C0DD', '#9BCA63', '#FCCE10', '#E87C25', '#27727B',
        '#FE8463', '#FAD860', '#F3A43B',
      ],
