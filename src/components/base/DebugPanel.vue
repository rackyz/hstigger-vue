<template>
   <Modal title="调试" fullscreen footer-hide draggable v-model="value" v-show='session && session.id' width="100%" @on-visible-change='OnVisibleChange' @on-cancel="onCancel" >
...
const keys = ['session','users','enterprises','types','modules','rss','user_rss','projects']
export default {
  data(){
    return {
      linesCount:0,
